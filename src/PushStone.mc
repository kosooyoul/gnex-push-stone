...
>	08	2009.02.19	그래픽 칩 케릭터 이미지 적용, 코드 수정 및 버그 발견

	09	2009.02.20	버그 수정 및 게임 재구현
	10	2009.02.21	상세 게임 구현 완료 및 게임 도움말과 옵션 구현, 다운 로드 테스트
	11	2009.02.22	배포ㅋㅋ 꿈이 야무지구나!!ㅋㅋ(상용화 문의!! 가능해!!)
