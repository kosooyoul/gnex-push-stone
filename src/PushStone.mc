/*
	PushStone (2009.01.12.Thu ~ 2009.01.17)
	by www.Ahyane.net ^^*
...
>	06	2009.02.17	선택 메뉴 수정, 각 모드 별 뼈대 및 그래픽 적용 작업
	...
	07	2009.02.18	각 모드 작업 마무리 및 상세 게임 구현
	08	2009.02.19	상세 게임 구현 완료 및 게임 도움말과 옵션 구현, 다운 로드 테스트
	09	2009.02.20	배포ㅋㅋ 꿈이 야무지구나!!ㅋㅋ(상용화 문의!! 가능해!!)
...
void Debug(){
	...
	DrawStr(130, 40, Temp);
	MakeStr1(Temp, "STT_SEL3 = %d", Status_Select[2]);
	DrawStr(130, 50, Temp);
